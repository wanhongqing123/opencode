...
const TIPS: Tip[] = [
  ...
  "Add reusable prompts from the account-scoped OpenCode configuration",
  "Use {highlight}$ARGUMENTS{/highlight}, {highlight}$1{/highlight}, {highlight}$2{/highlight} in custom commands for dynamic input",
  "Use backticks to inject shell output (e.g., {highlight}`git status`{/highlight})",
  "Add specialized agents from the account-scoped OpenCode configuration",
  ...
  "Create custom tools in the account-scoped OpenCode configuration",
  "Tool definitions can invoke scripts written in Python, Go, etc",
  "Add event plugins from the account-scoped OpenCode configuration",
  ...
  "Create JSON themes in the account-scoped OpenCode configuration",
